...
void hal_entry(void)
{
    ...
    LOG_I("\nTips:");
    LOG_I("If you want to use HS USB, please open the configuration.xml file, modify the two parameters of the usb_basic Stack:");
    LOG_I("USB Speed         ---> Hi Speed");
    LOG_I("USB Module Number ---> USB_IP1_port");
