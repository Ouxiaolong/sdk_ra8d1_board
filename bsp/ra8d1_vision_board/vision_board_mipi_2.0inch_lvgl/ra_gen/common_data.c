...
/* MIPI PHY Macros */
        ...
        {
            .pll_settings = /* Calculated MIPI PHY PLL frequency: 1000000000 Hz (error 0.00%) = (20000000 Hz / 1) * 50.00 / 1 */{.div      = 1 - 1,.pll_div  = 0, .mul_int  = 50 - 1,.mul_frac = 0 /* Value: 0 */},
            .lp_divisor   = 5 - 1,
...
mipi_dsi_instance_ctrl_t g_mipi_dsi0_ctrl;
        ...
        const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        {
            ...
            .horizontal_front_porch   = (515 - 480 - 20 - 4),
