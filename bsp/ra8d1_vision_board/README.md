...
**ra8d1_vision_board** is the support package developed by the RT-Thread team for the Vision-Board development board. It serves as a software SDK for users to simplify their application development process.
...
- vision_board_xxx: Consists of example project folders,.
