...
/* MIPI PHY Macros */
        ...
        {
            .pll_settings = /* Calculated MIPI PHY PLL frequency: 480000000 Hz (error 0.00%) = (24000000 Hz / 1) * 20.00 / 1 */{.div      = 1 - 1,.pll_div  = 0, .mul_int  = 20 - 1,.mul_frac = 0 /* Value: 0 */},
            .lp_divisor   = 5 - 1,
...
mipi_dsi_instance_ctrl_t g_mipi_dsi0_ctrl;
        ...
        const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        {
            ...
            .vertical_back_porch      = (8 - 4),
            .vertical_front_porch     = (496 - 480 - 8 - 4),
            .vertical_sync_polarity   = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),


            .horizontal_active_lines  = 222,
            .horizontal_sync_lines    = 40,
            .horizontal_back_porch    = (40 - 40),
            .horizontal_front_porch   = (350 - 222 - 40 - 40),
            .horizontal_sync_polarity = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),

            .video_mode_delay         = 169 /* This value was calculated by FSP. An override is available but not recommended for most users */,
