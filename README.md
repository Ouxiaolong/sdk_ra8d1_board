...
RA8D1系列 BSP 目前支持情况如下表所示：

| **BSP 文件夹名称**                               | **开发板名称**          |
|:------------------------------------------- |:------------------------------- |
| [ra8d1-cpk-board](bsp/ra8d1-cpk-board) | 瑞萨 官方 CPKCOR-RA8D1B核心板 |
| [ra8d1-vision-board](bsp/ra8d1-vision-board) | RT-Thread 推出 Vision-Board 开发板 |
